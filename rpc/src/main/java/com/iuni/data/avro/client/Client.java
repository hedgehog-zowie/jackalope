...
public abstract class Client implements Configurable {
    ...
    public void getData() throws RpcClientException {
        ...
        Schema requestEvtSchema = null;
        Schema requestEvtPvSchema = null;
        try {
    ...
    public void configure(Context context) {
        ...
        try {
            ...
            logger.error("config client - create protocol error, protopath is: {}, error msg is: {}", protopath, e.getLocalizedMessage());
        }
    }
