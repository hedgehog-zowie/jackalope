...
public class IpStoreTest {
    ...
    @Test
    public void testInitIpStore() throws IpException {
        ipStore.initIpStore();
    }

    @Test
    public void testRead() throws IOException, IpException {
    ...
    public void getAllCountry() throws IOException {
        String countryFilePath = IpStore.class.getResource(ipStore.countryPath).getPath();
